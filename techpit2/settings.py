"""
Django settings for techpit2 project.
...
SECRET_KEY = ')2@0$ltsvmb!=j#2y=wgkbtulk*q6-_+9eo*a-cq@zwn3k729_'
...
WSGI_APPLICATION = 'techpit2.wsgi.application'
